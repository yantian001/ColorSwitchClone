...
/// 
/// NOTE: Below with all of the Repetitive for Looping through lists, we should create a method that takes the list and some other parameters so
...
public class ColorColliderController : MonoBehaviour {
    ...
    void Start () 
	{
        ...
        //add active off-screen obstacles to list so that we can deactivate them, and later move them into
    ...
    public void GetObstacle(int obstacleNum, bool rotateObstacle, float starPosDifference, float colorPosDifference)
    {
        ...
        //set the "first" obstacles position as the starting position...
        ...
        if (rotateObstacle)
        {
            ...
            //and set its position the the same as the obstacle(it'll be inside the obstacle)
...
/// to cycle thru the list there may be 4 obstacles behind us, and 2 obstacles ahead of us.  I hope this was explained well 
...
/// </summary>
    ...
    {
        //boolean we will send to GetObsacle as a Parameter
        ...
        // through's.. This is definitely NOT the way this should be done, especially because the obstacles are not random/dynamic
        // but for the sake of a simple, understandable implementation that just about anyone could improve upon... I decided not
        // to spend any real time trying to do something elegant.

        // switch case for the obstacles.. It calls the GetObstacle(); with the appropriate parameters for each of 
